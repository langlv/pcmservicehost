...
BEGIN
    ...
    insert into drlrecmast(DRID,PPID,PRID,DMID,DRIVER,FMID,MPID,SID,DRILLTIME,DEEPMETER,DIRECTION,EMPTYDRILL,DRILLMETER,ROTATEMETER,RQ,RQTOTAL,AMP,PSR,NDN,RDQ,RDQTOTAL,STARTREC,ENDREC,RECBY,RECTIME,APPBY,APPTIME) 
    select DRID,PPID,PRID,DMID,DRIVER,FMID,MPID,SID,DRILLTIME,DEEPMETER,DIRECTION,EMPTYDRILL,DRILLMETER,ROTATEMETER,RQ,RQTOTAL,AMP,PSR,NDN,RDQ,RDQTOTAL,STARTREC,ENDREC,RECBY,RECTIME,APPBY,APPTIME
